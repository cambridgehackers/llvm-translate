...
void l_class_OC_Fifo_OC_2::in_enq(l_struct_OC_ValueType in_enq_v) {
}
bool l_class_OC_Fifo_OC_2::in_enq__RDY(void) {
        return 0;
}
void l_class_OC_Fifo_OC_2::out_deq(void) {
}
bool l_class_OC_Fifo_OC_2::out_deq__RDY(void) {
        return 0;
}
