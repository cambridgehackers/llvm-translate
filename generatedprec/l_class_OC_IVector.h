...
extern void l_class_OC_IVector__say(void *thisarg, BITS say_meth, BITS say_v);
...
public:
  ...
  void say(BITS say_meth, BITS say_v) { l_class_OC_IVector__say(this, say_meth, say_v); }
