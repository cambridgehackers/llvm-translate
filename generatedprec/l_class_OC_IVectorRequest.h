...
extern void l_class_OC_IVectorRequest__say(void *thisarg, BITS say_meth, BITS say_v);
...
public:
  void run();
  void commit();
  void say(BITS say_meth, BITS say_v) { l_class_OC_IVectorRequest__say(this, say_meth, say_v); }
